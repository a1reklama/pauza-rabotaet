...
<section class="pauza-section">
    <div class="pauza-container">
        <div class="pauza-next-box">
            ...
            <button class="pauza-button pauza-button--primary" type="button" data-sponsor-consent aria-expanded="false"><?php esc_html_e('Я ознакомился', 'pauza-rabotaet'); ?></button>
        </div>
