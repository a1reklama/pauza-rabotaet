...
get_header();
pauza_archive_title('12 шагов для ВСЕХ', 'Карта программы. Внутри шага: работа по документу, материалы шага и текст руководителя.');
?>
                ...
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    <article class="pauza-step-row">
                        ...
                        <div>
                            ...
                            <?php endif; ?>
                            <h2><a href="<?php the_permalink(); ?>"><?php echo esc_html(pauza_step_display_title($number)); ?></a></h2>
