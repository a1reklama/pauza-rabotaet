...
function pauza_seed_options(): void
{
    ...
    $defaults = [
        ...
        'privacy_notice'             => 'Публично показываются только подтвержденные контакты. Большая просьба не звонить: сначала напиши сообщение, представься и коротко расскажи о себе.',
...
function pauza_seed_steps(): void
{
    ...
    $steps = [
        [
            ...
            'max' => 'https://max.ru/join/9Zf383ZqPAril7DDomO-iKpTBiJfbD3xIkGj_Tnd3Ws',
        ...
        [
            ...
            'status' => 'Внешний бот',
            'goal' => 'Вспомнить всех, к кому на протяжении жизни испытывали негативные эмоции, и увидеть истинную сущность своих ошибок.',
            'content' => "Мы стараемся вспомнить всех, к кому на протяжении своей жизни испытывали негативные эмоции, разбираемся в том, что было причиной этого, начинаем видеть, как наши слова и действия причиняли вред прежде всего нам самим и определяем свои дефекты характера, которые и составляли истинную сущность наших ошибок.\n\nРаботаем в боте - либо в Телеграм, либо в Максе - продолжительность работы 89 дней.",
            'requirements' => [
                'Третий шаг завершен.',
                'Есть спонсор для сопровождения.',
            ],
            'tasks' => [
                'Мы стараемся вспомнить всех, к кому на протяжении своей жизни испытывали негативные эмоции, разбираемся в том, что было причиной этого, начинаем видеть, как наши слова и действия причиняли вред прежде всего нам самим и определяем свои дефекты характера, которые и составляли истинную сущность наших ошибок.',
                'Работаем в боте - либо в Телеграм, либо в Максе - продолжительность работы 89 дней.',
            ],
        ...
        [
            ...
            'status' => 'Со спонсором',
            'goal' => 'Встретиться с человеком, которому доверяем, и признаться в ошибках и их истинной сущности.',
            'content' => "Мы встречаемся с человеком, которому доверяем, и с верой, что на этой встрече присутствует любящий Бог, признаёмся не только в тех ошибках, которые совершали на протяжении всей своей жизни, но и в том, что истинной сущностью этих ошибок всегда был наш эгоцентризм и дефекты характера, которые заставляли нас верить в то, что мы недостойны любви и принятия.\n\nВстреча со спонсором ориентировочно 7 часов. Желательно живьем, лицом к лицу, если только не разные враждующие страны или отсутствие возможности выехать. Во всех остальных случаях надо встречаться - многие едут тысячи километров.",
            'requirements' => [
                'Четвертый шаг выполнен в боте или другом утвержденном формате.',
                'Встреча со спонсором согласована заранее.',
            ],
            'tasks' => [
                'Мы встречаемся с человеком, которому доверяем, и с верой, что на этой встрече присутствует любящий Бог, признаёмся не только в тех ошибках, которые совершали на протяжении всей своей жизни, но и в том, что истинной сущностью этих ошибок всегда был наш эгоцентризм и дефекты характера, которые заставляли нас верить в то, что мы недостойны любви и принятия.',
                'Встреча со спонсором ориентировочно 7 часов. Желательно живьем, лицом к лицу, если только не разные враждующие страны или отсутствие возможности выехать. Во всех остальных случаях надо встречаться - многие едут тысячи километров.',
            ],
            'telegram' => '',
            'max' => '',
...
function pauza_seed_menu(int $home_id, int $calculator_id, int $bot_id): void
{
    ...
    pauza_remove_menu_items((int) $menu_id, ['Начать', 'Спонсоры', 'Материалы', 'Группа', '12 шагов', 'Бот 4 шага', 'Калькулятор', 'Калькуляторы', 'Только сегодня', 'Новости', 'Еще']);
